...
retailerslist = copy.deepcopy(features_list_base[:13])                                               #Because of total 13 retailers, when sheets other than BrandFlagExternal is used need to change the number
...
Valid_dict = dict((k, v) for k, v in valid_features.items() if v >=130)
